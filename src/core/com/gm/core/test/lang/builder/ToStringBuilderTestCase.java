package com.gm.core.test.lang.builder;
...
public class ToStringBuilderTestCase extends TestCase {
	...
	public void testToStringBuilder() {
		Person p = new Person("azheng", 25, "peng");
	...
	public void testAppend() {
		...
		TestCase.assertTrue(builder.toString().contains("name=azheng,age=25"));
	}

	public void testReflectionToString() {
		Person p = new Person("azheng", 25, "peng");
		TestCase.assertTrue(ToStringBuilder.reflectionToString(p).toString()
				.contains("name=azheng,age=25,nickName=peng"));
		TestCase.assertTrue(ToStringBuilder.reflectionToString(p, "abc").toString()
				.contains("name=azheng,age=25,nickName=peng"));
		TestCase.assertTrue(ToStringBuilder.reflectionToString(p, "age").toString()
				.contains("name=azheng,nickName=peng"));
	}
