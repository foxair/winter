...
import com.gm.codegen.util.AntPathMatcher;
import com.gm.codegen.util.BeanHelper;
import com.gm.codegen.util.FileHelper;
import com.gm.codegen.util.FreemarkerHelper;
...
public class Generator {
	...
	public void makeOutRootDir() throws IOException {
		if (StringHelper.isBlank(getOutRootDir()))
			throw new IllegalStateException("'outRootDir' property must be not null.");
		GLogger.println("[make dir]    " + getOutRootDir());
		new File(getOutRootDir()).mkdirs();
	}
