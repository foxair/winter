...
public class YahooImapSocketFactory extends SocketFactory {
	...
	private class YahooImapSocket extends Socket {
		...
		public YahooImapSocket(String host, int port) throws IOException, UnknownHostException {
			super(host, port);
		}
		...
		public YahooImapSocket(String host, int port, InetAddress localHost, int localPort) throws IOException,
				UnknownHostException {
			super(host, port, localHost, localPort);
		}

		public YahooImapSocket(InetAddress address, int port, InetAddress localAddress, int localPort)
				throws IOException {
