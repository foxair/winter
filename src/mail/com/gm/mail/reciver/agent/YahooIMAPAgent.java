/*
 *@# YahooIMAPAgent.java 3:42:40 PM Jul 22, 2009
...
public class YahooIMAPAgent extends IMAPAgent {
	...
	static {
		...
		defaultProperties.setProperty("mail.imap.socketFactory.class",
				"com.uncle.mymailreciver.agent.YahooImapSocketFactory");
	...
	public boolean login(String folderName) throws Exception {
		...
		store.connect(super.getSetting().getHostAddress(), super.getSetting().getPort(), super.getSetting()
				.getUserName(), super.getSetting().getPwd());
		//设置Folder成员
